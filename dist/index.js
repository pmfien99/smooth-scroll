...
(() => {
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.5/node_modules/@gsap/shockingly/ScrollSmoother.js
  ...
  var _maxScroll = function _maxScroll2(scroller) {
    return ScrollTrigger.maxScroll(scroller || _win3);
  };
  ...
  var ScrollSmoother = /* @__PURE__ */ function() {
    function ScrollSmoother2(vars) {
      var _this = this;
      _coreInitted2 || ScrollSmoother2.register(gsap2) || console.warn("Please gsap.registerPlugin(ScrollSmoother)");
      vars = this.vars = vars || {};
      _mainInstance && _mainInstance.kill();
      _mainInstance = this;
      _context2(this);
      var _vars = vars, smoothTouch = _vars.smoothTouch, _onUpdate = _vars.onUpdate, onStop = _vars.onStop, smooth = _vars.smooth, onFocusIn = _vars.onFocusIn, normalizeScroll = _vars.normalizeScroll, wholePixels = _vars.wholePixels, content, wrapper, height, mainST, effects, sections, intervalID, wrapperCSS, contentCSS, paused, pausedNormalizer, recordedRefreshScroll, recordedRefreshScrub, allowUpdates, self = this, effectsPrefix = vars.effectsPrefix || "", scrollFunc = ScrollTrigger.getScrollFunc(_win3), smoothDuration = ScrollTrigger.isTouch === 1 ? smoothTouch === true ? 0.8 : parseFloat(smoothTouch) || 0 : smooth === 0 || smooth === false ? 0 : parseFloat(smooth) || 0.8, speed = smoothDuration && +vars.speed || 1, currentY = 0, delta = 0, startupPhase = 1, tracker = _getVelocityProp(0), updateVelocity = function updateVelocity2() {
            ...
            onUpdate: function onUpdate(self2) {
              ...
              if (self2.offset) {
                if (i) {
                  ...
                  y = startY + extraY + change * ((gsap2.utils.clamp(self2.start, self2.end, scrollY) - self2.start - extraY) / (end - self2.start) - progressOffset);
                }
      ...
      function refreshHeight() {
        ...
        _body.style.height = _win3.innerHeight + (height - _win3.innerHeight) / speed + "px";
      ...
      mainST = ScrollTrigger.create({
        ...
        onRefresh: function onRefresh2(self2) {
          ...
          if (!startupPhase) {
            ...
            self2.animation.progress(gsap2.utils.clamp(0, 1, recordedRefreshScroll / speed / -self2.end));
          }
      ...
      "overscrollBehavior" in _win3.getComputedStyle(_body) && gsap2.set([_body, _docEl], {
        overscrollBehavior: "none"
      });
      "scrollBehavior" in _win3.getComputedStyle(_body) && gsap2.set([_body, _docEl], {
        scrollBehavior: "auto"
      });
    ...
    ScrollSmoother2.register = function register(core) {
      if (!_coreInitted2) {
        ...
        if (gsap2) {
          ...
          gsap2.core.globals("ScrollSmoother", ScrollSmoother2);
  ...
  _getGSAP() && gsap2.registerPlugin(ScrollSmoother);

  // src/index.ts
  window.Webflow ||= [];
  window.Webflow.push(() => {
    gsapWithCSS.registerPlugin(ScrollSmoother);
